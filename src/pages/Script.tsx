            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  date: "最新",
                  details: [
                    "1、所有的视频里都不要出现路人的脸，包括那种街拍的视频，哪怕人不是主体也要注意，如果是某个建筑或者风景，实在难以避免，可以通过剪辑手法，只让人脸出现1-2秒，咱们要完全避免掉被出镜人刷到——申诉的风险",
                    "2、所有的同学把自己电脑里做视频的素材上传到nas，我们要对视频素材进行统一的审查",
                    "3、A脚本+B脚本，A脚本不能拉踩第三方，比如铁路局、其他app、竞争对手等，B脚本要绝对真实，不能虚假，多少优惠就是多少，每天审核时间改成下午四点前必须发在群里，目的是如果出现问题，大家有时间去修改视频。"
                  ]
                },
              ].map((risk, idx) => (
                <div
