              ...
              <Card className="p-3 bg-secondary">
                ...
                <div className="grid grid-cols-1 gap-2 mb-3">
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedTopic === 1 ? "bg-background border-primary border-2" : ""}`}
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedTopic === 2 ? "bg-background border-primary border-2" : ""}`}
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedTopic === 3 ? "bg-background border-primary border-2" : ""}`}
                ...
                <div className="grid grid-cols-1 gap-2 mb-3">
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedTemplate === 1 ? "bg-background border-primary border-2" : ""}`}
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedTemplate === 2 ? "bg-background border-primary border-2" : ""}`}
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedTemplate === 3 ? "bg-background border-primary border-2" : ""}`}
                ...
                <div className="grid grid-cols-1 gap-2 mb-3">
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedBenefit === 1 ? "bg-background border-primary border-2" : ""}`}
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedBenefit === 2 ? "bg-background border-primary border-2" : ""}`}
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className={`text-xs hover:bg-background hover:border-primary hover:border-2 ${selectedBenefit === 3 ? "bg-background border-primary border-2" : ""}`}
